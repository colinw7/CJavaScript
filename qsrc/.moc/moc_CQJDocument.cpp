...
#include <memory>
#include "../../qinclude/CQJDocument.h"
...
QT_INIT_METAOBJECT const QMetaObject CQJDocument::staticMetaObject = { {
    QMetaObject::SuperData::link<CQJObject::staticMetaObject>(),
    qt_meta_stringdata_CQJDocument.data,
    qt_meta_data_CQJDocument,
    qt_static_metacall,
    nullptr,
    nullptr
} };
