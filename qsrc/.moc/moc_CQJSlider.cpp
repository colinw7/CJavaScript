...
void CQJSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CQJSlider *_t = static_cast<CQJSlider *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CQJSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_CQJSlider.data,
      qt_meta_data_CQJSlider,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CQJSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CQJSlider.stringdata0))
        return static_cast<void*>(const_cast< CQJSlider*>(this));
