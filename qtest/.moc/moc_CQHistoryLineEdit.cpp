...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CQHistoryLineEdit_t, stringdata) + ofs \
...
void CQHistoryLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CQHistoryLineEdit *_t = static_cast<CQHistoryLineEdit *>(_o);
        switch (_id) {
        ...
        {
            typedef void (CQHistoryLineEdit::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CQHistoryLineEdit::exec)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CQHistoryLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_CQHistoryLineEdit.data,
      qt_meta_data_CQHistoryLineEdit,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CQHistoryLineEdit.stringdata))
        return static_cast<void*>(const_cast< CQHistoryLineEdit*>(this));
