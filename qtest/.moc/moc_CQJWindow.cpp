...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CQJWindow_t, stringdata) + ofs \
...
void CQJWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CQJWindow *_t = static_cast<CQJWindow *>(_o);
        switch (_id) {
...
const QMetaObject CQJWindow::staticMetaObject = {
    { &CQJObject::staticMetaObject, qt_meta_stringdata_CQJWindow.data,
      qt_meta_data_CQJWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CQJWindow.stringdata))
